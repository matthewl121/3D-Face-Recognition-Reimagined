...
def main(video_source=0):
    ...
    while True:
        ...
        cv2.putText(frame_small, f'FPS: {fps:.2f}', (frame_small.shape[1] - 80, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 0), 1)
        cv2.putText(frame_small, f'Latency: {latency:.2f}', (frame_small.shape[1] - 110, 60), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 0), 1)
